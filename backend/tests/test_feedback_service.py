...
class TestFeedbackServiceSubmitThumb:
    ...
    @pytest.mark.asyncio
    async def test_persists_thumb_event(self, mocker: MockerFixture) -> None:
        ...
        thumbs_repo: Any = mocker.AsyncMock()
        edits_repo: Any = mocker.AsyncMock()
...
class TestFeedbackServiceSubmitEdit:
    ...
    @pytest.mark.asyncio
    async def test_persists_edit_event(self, mocker: MockerFixture) -> None:
